...
An interactive Power BI dashboard designed to monitor Emergency Room (ER) performance by analyzing patient visits, waiting time, satisfaction scores, admissions, referrals, and demographic trends. The dashboard helps healthcare administrators make data-driven decisions to improve operational efficiency and patient care.

📖 Short Description / Purpose

The Hospital Emergency Room Dashboard is a comprehensive Power BI report that provides real-time insights into emergency department operations. It enables hospital management to monitor key performance indicators (KPIs), evaluate patient flow, identify peak visiting hours, analyze referral patterns, and improve overall service quality through interactive visualizations.

🛠 Tech Stack

The dashboard was built using the following tools and technologies:<br>

📊 Power BI Desktop – Dashboard development and interactive reporting.<br>
🔄 Power Query – Data cleaning, transformation, and preparation.<br>
🧠 DAX (Data Analysis Expressions) – Calculated measures, KPIs, and dynamic calculations.<br>
🔗 Data Modeling – Relationships between tables for accurate analysis.<br>
📈 Data Visualization – KPI Cards, Bar Charts, Donut Charts, Heatmap, and Slicers.<br>
📁 File Format – .pbix for development and .png for dashboard preview.<br>

⭐ Features / Highlights
Business Problem

Hospital emergency departments handle a large number of patients daily, making it difficult to monitor operational performance using raw data.
